...
public class MoonFall extends LunarAbility implements AddonAbility {
    ...
    private void setFields() {
        ...
        this.cooldown = ProjectCosmos.plugin.getConfig().getInt("Abilities.Cosmic.Lunar.MoonFall.Cooldown");
        this.chargeTime = ProjectCosmos.plugin.getConfig().getInt("Abilities.Cosmic.Lunar.MoonFall.ChargeTime");
        this.range = ProjectCosmos.plugin.getConfig().getDouble("Abilities.Cosmic.Lunar.MoonFall.Range");
        this.damage = ProjectCosmos.plugin.getConfig().getDouble("Abilities.Cosmic.Lunar.MoonFall.Damage");
    ...
    private void Star() {
        if (!GeneralMethods.isRegionProtectedFromBuild(player, "MoonFall", location)) {
    ...
    public boolean isEnabled() {
        return ProjectCosmos.plugin.getConfig().getBoolean("Abilities.Cosmic.Lunar.MoonFall.Enabled");
    }
